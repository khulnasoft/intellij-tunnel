 ...
 */
public class TunnelSettingsComponent {

    private final JPanel settingsPanel;
    private final TextFieldWithBrowseButton TunnelPath = new TextFieldWithBrowseButton();
    ...
    public TunnelSettingsComponent() {

        TunnelPath.addBrowseFolderListener("Tunnel binary path", "Set the explicit path to Tunnel",
                ProjectManager.getInstance().getDefaultProject(), FileChooserDescriptorFactory.createSingleFileDescriptor());

        settingsPanel = FormBuilder.createFormBuilder()
                .addComponent(new TitledSeparator("Path to Tunnel"))
                .addLabeledComponent(new JBLabel(), TunnelPath, 1, true)
                ...
                .addComponent(new TitledSeparator("The Remote Tunnel url to connect to "))
    ...
    public void setTunnelPath(@NotNull String newText) {
        TunnelPath.setText(newText);
    }
